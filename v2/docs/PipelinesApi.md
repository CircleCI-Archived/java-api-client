...
------------- | ------------- | -------------
[**getPipelineById**](PipelinesApi.md#getPipelineById) | **GET** /pipeline/{pipeline-id} | Get a pipeline
...
import com.circleci.client.v2.api.PipelinesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling PipelinesApi#getPipelineById");
