...
[**projectProjectSlugSchedulePost**](DefaultApi.md#projectProjectSlugSchedulePost) | **POST** /project/{project-slug}/schedule | 
[**rerunWorkflow**](DefaultApi.md#rerunWorkflow) | **POST** /workflow/{id}/rerun | Rerun a workflow
[**scheduleScheduleIdGet**](DefaultApi.md#scheduleScheduleIdGet) | **GET** /schedule/{schedule-id} | 
[**scheduleScheduleIdPatch**](DefaultApi.md#scheduleScheduleIdPatch) | **PATCH** /schedule/{schedule-id} | 
...
public class Example {
    public static void main(String[] args) {
        ...
        String branch = "branch_example"; // String | The name of a vcs branch. If not passed we will scope the API call to the default branch.     Note - Querying all branches is not supported yet.
...
## projectProjectSlugSchedulePost

> InlineResponseDefault projectProjectSlugSchedulePost(projectSlug)
...
public class Example {
    public static void main(String[] args) {
        ...
        String projectSlug = gh/CircleCI-Public/api-preview-docs; // String | Project slug in the form `vcs-slug/org-name/repo-name`. The `/` characters may be URL-escaped.
        try {
            InlineResponseDefault result = apiInstance.projectProjectSlugSchedulePost(projectSlug);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#projectProjectSlugSchedulePost");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## scheduleScheduleIdGet

> InlineResponseDefault scheduleScheduleIdGet(scheduleId)
...
public class Example {
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi(defaultClient);
        UUID scheduleId = new UUID(); // UUID | The unique ID of the schedule.
        try {
            InlineResponseDefault result = apiInstance.scheduleScheduleIdGet(scheduleId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#scheduleScheduleIdGet");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **scheduleId** | [**UUID**](.md)| The unique ID of the schedule. |
...
## scheduleScheduleIdPatch

> InlineResponseDefault scheduleScheduleIdPatch(scheduleId)
...
public class Example {
    public static void main(String[] args) {
        ...
        UUID scheduleId = new UUID(); // UUID | The unique ID of the schedule.
        try {
            InlineResponseDefault result = apiInstance.scheduleScheduleIdPatch(scheduleId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#scheduleScheduleIdPatch");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
