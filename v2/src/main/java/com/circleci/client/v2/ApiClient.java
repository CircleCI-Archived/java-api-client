...
import com.circleci.client.v2.auth.Authentication;
import com.circleci.client.v2.auth.HttpBasicAuth;
import com.circleci.client.v2.auth.HttpBearerAuth;
import com.circleci.client.v2.auth.ApiKeyAuth;


public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://circleci.com/api/v2";
